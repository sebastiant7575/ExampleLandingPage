...
const ServicesPage = () => {
  return (      
    <div id="second" className="min-h-screen flex flex-col items-center justify-center bg-accent text-white">
              ...
              <div className="relative flex h-[450px] lg:h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)] shadow-md">
                <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0 group">
                  <p className="relative mt-2 text-xl font-medium tracking-tight text-black max-lg:text-center">
                    Mobile friendly
                    <span
                      className="absolute left-0 -bottom-0.5 h-0.5 w-0 bg-accent transition-all duration-300 group-hover:max-md:w-0 group-hover:lg:w-32"
                    ></span>
                  </p>
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10 group">
                  <p className="relative mt-2 text-xl font-medium tracking-tight text-black max-lg:text-center">
                    Performance
                    <span
                      className="absolute left-0 -bottom-0.5 h-0.5 w-0 bg-accent transition-all duration-300 group-hover:max-md:w-0 group-hover:lg:w-28"
                    ></span>
                  </p>
                  <p className="relative mt-2 max-w-lg text-sm/6 text-pretty text-gray-600 max-lg:text-center">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10 group">
                  <p className="relative mt-2 text-xl font-medium tracking-tight text-black max-lg:text-center">
                    Maintenance & Hosting
                    <span
                      className="absolute left-0 -bottom-0.5 h-0.5 w-0 bg-accent transition-all duration-300 group-hover:max-md:w-0 lg:group-hover:w-50"
                    ></span>
                  </p>
                  <p className="relative mt-2 max-w-lg text-sm/6 text-pretty text-gray-600 max-lg:text-center">
              ...
              <div className="relative flex h-[450px] lg:h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0 group">
                  <p className="relative mt-2 text-xl font-medium tracking-tight text-black max-lg:text-center">
                    Modern Designs
                    <span
                      className="absolute left-0 -bottom-0.5 h-0.5 w-0 bg-accent transition-all duration-300 group-hover:max-md:w-0 group-hover:lg:w-35"
                    ></span>
                  </p>
